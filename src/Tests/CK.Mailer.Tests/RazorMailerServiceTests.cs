...
namespace CK.Mailer.Tests
{
    ...
    public class RazorMailerServiceTests
    {
        ...
        public async Task send_email_from_razor_mail_sender_must_be_append_in_PickupDirectory()
        {
            ...
            RazorMimeMessage mail = FM.Create_RazorMailModel_with_to_from_subject_body_generated_values();
            ...
            var model = FM.Create_TemplateModel_with_generated_value();

            //send mail with BasicMailModel overload
            await service.SendInlineTemplateAsync( m, mail, "Hello @Model.TheVariable", model );
            ...
            sentMail.HtmlBody.Should().Be( $"Hello {model.TheVariable}" );
            sentMail.TextBody.Should().Be( $"Hello {model.TheVariable}" );
        }
        ...
        public async Task send_email_from_static_sender_with_MimeMessage_overload_must_be_append_in_PickupDirectory()
        {
            ...
            SimpleMimeMessage mail = FM.Create_BasicMailModel_with_to_from_subject_body_generated_values();

            //send mail with MimeMessage overload
            await StaticMailerService.SendMailAsync( m, DefaultMailKitOptions.Default, mail );
            ...
            sentMail.Subject.Should().Be( mail.Subject );
            sentMail.HtmlBody.Should().Be( mail.HtmlBody );
        ...
        public async Task send_email_with_default_email_sender()
        {
            ...
            SimpleMimeMessage mail = FM.Create_BasicMailModel_without_from_mail_address();
